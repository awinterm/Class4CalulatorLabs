 ...
 * @author andre_000
 */
@WebServlet(name = "RectangleController", urlPatterns = {"/RectangleCalculator"})
public class RectangleController extends HttpServlet {
    
    private final String RESPONSE_PAGE = "/RectangleResponse.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         try (PrintWriter out = response.getWriter()) {
            ...
            String responseMsg = RectangleServ.getCalculatedArea();
